...
ACTION_RUNTIME_SPECS.update(
    {
        ...
        for spec in (
            ...
            RuntimeActionSpec(
                ...
                execution_mode="DISCRETE",
                task_ids=("Mjlab-SquatReference-Flat-MicroDuck",),
                required_capabilities=("FLAT_TERRAIN",),
                reset_profile="DEFAULT_STANDING",
                command_profile="COS_SIN_SQUAT_REFERENCE_PHASE",
                phase_period_s=5.0,
                kick_mirror="NONE",
                fall_policy="FAIL_ON_FALL",
