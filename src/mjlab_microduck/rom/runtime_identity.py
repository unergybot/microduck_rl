...
GOVERNED_RUNTIME_MODULES = (
    ...
    "rom/navigation/__init__.py",
    "rom/navigation/environment.py",
    "rom/navigation/follower.py",
    "rom/navigation/grid.py",
    "rom/navigation/installation.py",
    "rom/navigation/planner.py",
    "rom/navigation_api.py",
    "rom/navigation_contracts.py",
    "rom/navigation_service.py",
    "rom/observation.py",
    "rom/onnx_policy.py",
